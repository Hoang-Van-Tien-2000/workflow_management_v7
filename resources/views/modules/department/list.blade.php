                    ...
                    <div class="row">
                        <div class="col-12 mb-4">
                            <div class="row">
                                ...
                                @if(Auth::user()->hasPermissionTo("Thêm phòng ban"))
                                <div class="col-9">
                        ...
                        @if(Auth::user()->hasPermissionTo("Xóa phòng ban"))
                        <div class="col-12 mb-4">
                            <div class="row">
                                <div class="col-3">
