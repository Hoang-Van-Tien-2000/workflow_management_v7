                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="row">
                                ...
                                @if(Auth::user()->hasPermissionTo("Thêm xử phạt"))
                                <div class="col-9">
                                    <div class="d-lg-flex justify-content-end">
                                        <a href="{{ route('discipline.create') }}" id="btn-them-moi" class="btn btn-primary mt-2 mt-lg-1">
                        ...
                        @if(Auth::user()->hasPermissionTo("Xóa xử phạt"))
                        ...
                        <div class="col-12">
                            <div class="statbox widget box box-shadow">
                                <div class="widget-content widget-content-area">
                                    <table id="discipline" class="table style-2  table-hover">
                                        <thead>
                                            <tr>
    ...
    var table;
        ...
        function resetTable () {
            table = $('#discipline').DataTable({
                ...
                ajax: {
                    url: "{{route('discipline.load_ajax_list_discipline')}}",
                    type: 'get'
                },
                select: {
                    style:    'multi',
                ...
                initComplete: function(settings, json) {
                    $('#discipline tbody').on('click', 'input[type="checkbox"]', function(e) {
                ...
                // $('#discipline').on('click', 'tbody td, thead th:first-child', function(e) {
                ...
                $('thead input[name="select_all"]', table.table().container()).on('click', function(e) {
                    if (this.checked) {
                        $('#discipline tbody input[type="checkbox"]:not(:checked)').trigger('click');
                    } else {
                        $('#discipline tbody input[type="checkbox"]:checked').trigger('click');
                    }
                ...
                $("#discipline").parent().addClass(' table-responsive');
                $("#discipline").parent().parent().addClass(' d-inline');
                },
                ...
                columns: [
                    ...
                    { name: 'salary_fine', defaultContent: '',data: 'salary_fine',bSortable: true},
