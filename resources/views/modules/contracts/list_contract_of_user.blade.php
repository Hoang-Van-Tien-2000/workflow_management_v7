    ...
    <div class="row project-cards">
        <div class="col-md-12">
            <div class="card">
                <div class="card-body">
                    <div class="row">
                        @if(Auth::user()->hasPermissionTo("Gia hạn hợp đồng"))
                        <div class="col-12 mb-4">
                            <div class="row">
                                <div class="col-12">
                                    <div class="d-lg-flex justify-content-end">
                                        <a href="{{ route('contracts.renew_page', ['id' => $user->id]) }}" id="btn-them-moi" class="btn btn-primary mt-2 mt-lg-1">
                                            <i class="bx bxs-plus-square"></i>Gia hạn
                                        </a>
                                    </div>
                                </div>
                            </div>
    ...
    var table;
        ...
        function resetTable () {
            table = $('#contract').DataTable({
                ...
                ajax: {
                    url: "{{route('contracts.load_ajax_list_contract_of_user')}}",
                    data: {user_id: "{{$id}}"},
                    type: "get"
                },
                select: {
                ...
                columnDefs: [
                    {
                        ...
                        render: function(data,type, columns){
                            ...
                            var urlUpdate = "/hop-dong/nguoi-dung/{{$user->id}}/cap-nhat/"+ columns.id;
