                    ...
                    <div class="row">
                        <div class="col-12 mb-4">
                            <div class="row">
                                ...
                                @if(Auth::user()->hasPermissionTo("Danh sách tất cả hợp đồng"))
                                <div class="col-3">
                                    <div class="d-lg-flex justify-content-end">
                                        <a href="{{ route('contracts.list') }}" id="btn-them-moi" class="btn btn-primary mt-2 mt-lg-1">
                                            <i class="bx bxs-plus-square"></i>Danh sách hợp đồng
                                        </a>
                                    </div>
                                </div>
                                @endif
    ...
    var table;
        ...
        function resetTable () {
            table = $('#user').DataTable({
                ...
                ajax: {
                    url: "{{route('contracts.load_ajax_list_user')}}",
                    type: 'get'
                },
                select: {
                    style:    'multi',
                ...
                columnDefs: [
                    ...
                    },
                    {
                        ...
                        render: function(data,type, columns){
                            var urlList =  "./nguoi-dung/"+ columns.id;
                            var urlAdd =  "./nguoi-dung/gia-han/"+ columns.id;
                            return '<div class="d-flex order-actions">'
                            +'<a href="'+ urlList +'" class="bs-tooltip" data-toggle="tooltip" data-placement="top" title="" data-original-title="Edit"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-eye"><path d="M1 12s4-8 11-8 11 8 11 8-4 8-11 8-11-8-11-8z"></path><circle cx="12" cy="12" r="3"></circle></svg></a>'
                            +' @if(Auth::user()->hasPermissionTo("Gia hạn hợp đồng")) <a href="'+ urlAdd +'" class="bs-tooltip ml-3" data-toggle="tooltip" data-placement="top" title="" data-original-title="Edit"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-plus-circle"><circle cx="12" cy="12" r="10"></circle><line x1="12" y1="8" x2="12" y2="16"></line><line x1="8" y1="12" x2="16" y2="12"></line></svg></a> @endif'
                            +'</div>' 
                        }
                    },
