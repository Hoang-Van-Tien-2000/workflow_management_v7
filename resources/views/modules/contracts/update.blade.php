                    ...
                    <form method="POST" id="frm-cap-nhat" data-parsley-validate="" novalidate>
                        ...
                        <div class="row">
                            <div class="col-md-6 col-sm-12" >
                                ...
                                <select class="form-control custom-select2" disabled
                            ...
                            <div class="col-md-6 col-sm-12" style="margin-bottom:1%">
                                ...
                                <input type="text" class="form-control" id="code_nv" name="code_nv" 
                                value="{{$contract->user->code}}"
                                readonly>
                            </div>
                        </div>
                        <div class="row">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 col-sm-12" style="margin-bottom:1%">
                                ...
                                value="{{$contract->user->citizen_identification}}"
