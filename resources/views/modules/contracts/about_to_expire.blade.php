...
@csrf
<a href="{{route('contracts.list')}}" style="color:blue">Danh sách hợp đồng</a><span> / Danh sách hợp đồng sắp hết hạn </span>
                ...
                columnDefs: [
                    {
                        ...
                        render: function(data,type, columns){
                            ...
                            var urlAdd =  "./nguoi-dung/gia-han/"+ columns.user_id;
