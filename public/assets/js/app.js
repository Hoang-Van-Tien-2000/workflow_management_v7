var App = (function() {
    ...
    var toggleFunction = {
        sidebar: function($recentSubmenu) {
            $('.sidebarCollapse').on('click', function(sidebar) {
                ...
                get_CompactSubmenuShowContainerActive = document.querySelector(
                ...
                if (window.innerWidth <= 1199) {
                    if (get_overlay.classList.contains('show-sidebar')) {
                        get_overlay.classList.remove('show-sidebar');
                    } else {
                        get_overlay.classList.add('show-sidebar');
                    }
                }
            ...
            if (toogleNotification) {
                document
                    ...
                    .addEventListener('click', function() {
                        ...
                        document
                            .querySelector('body')
                            .classList.add('sidebar-noneoverflow');
                        document
                            .querySelector('html')
                            .classList.add('sidebar-noneoverflow');
                    });
    ...
    var inBuiltfunctionality = {
        ...
        toggleFixedSubmenuCollapserOnScroll() {
            getAdminDataContentElement = document.querySelector(
                '.admin-data-content'
            );
